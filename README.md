...
| --- | --- | --- | --- |
| Step 1 | Environment + IPPO baseline | IPPO reaches 25-45% demand satisfaction over 500 eval episodes | not started |
...
Current gate: §9 Step 1, Environment + IPPO baseline. No gate work has started yet.
